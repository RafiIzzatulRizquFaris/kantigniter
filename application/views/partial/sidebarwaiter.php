<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item <?php echo $this->uri->segment(2) == 'index' ? 'active': '' ?>">
				<a class="nav-link" href="<?php echo site_url('Waiter/index');?>">
                <i class="fas fa-fw fa-clipboard"></i>
					<span>Order Input</span></a>
			</li>

			<li class="nav-item <?php echo $this->uri->segment(2) == 'dataorder' ? 'active': '' ?>">
				<a class="nav-link" href="<?php echo site_url('Waiter/dataorder');?>">
			...
			<li class="nav-item <?php echo $this->uri->segment(2) == 'dataproduct' ? 'active': '' ?>">
				<a class="nav-link" href="<?php echo site_url('Waiter/dataproduct');?>">
					<i class="fas fa-fw fa-database"></i>
